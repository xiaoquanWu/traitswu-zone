...
<head>
    ...
    <link href="<%=path%>/resources/css/animation.css" rel="stylesheet">
    <!-- 返回顶部调用 begin -->
    <link href="<%=path%>/resources/css/lrtk.css" rel="stylesheet"/>
...
<header>
    <nav id="nav">
        ...
        <script src="<%=path%>/resources/js/silder.js"></script>
        <!--获取当前页导航 高亮显示标题-->
    </nav>
</header>
<!--header end-->
<div id="mainbody">
    <div class="info">
        <figure><img src="<%=path%>/resources/images/art.jpg" alt="Panama Hat">
    ...
    <div class="blogs">
        <ul class="bloglist">
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="<%=path%>/resources/images/s1.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="<%=path%>/resources/images/s2.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="<%=path%>/resources/images/s3.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
                    <ul class="textinfo">
                        <a href="/"><img src="<%=path%>/resources/images/s4.jpg"></a>
            ...
            <li>
                <div class="arrow_box">
                    ...
                    <ul class="textinfo">
                        <a href="/"><img src="<%=path%>/resources/images/s5.jpg"></a>
        ...
        <aside>
            ...
            <div class="toppic">
                <h2>图文并茂</h2>
                <ul>
                    <li><a href="/"><img src="<%=path%>/resources/images/k01.jpg">腐女不可怕，就怕腐女会画画！
                        <p>伤不起</p>
                    </a></li>
                    <li><a href="/"><img src="<%=path%>/resources/images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
                        <p>感兴趣</p>
                    </a></li>
                    <li><a href="/"><img src="<%=path%>/resources/images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
                        <p>喜欢</p>
                    </a></li>
                </ul>
            </div>
            ...
            <div class="viny">
                <dl>
                    <dt class="art"><img src="<%=path%>/resources/images/artwork.png" alt="专辑"></dt>
                    ...
                    <dd class="music">
                        <audio src="<%=path%>/resources/images/nf.mp3" controls></audio>
                    </dd>
...
<footer>
    <div class="footer-mid">
        ...
        <div class="visitors">
            <h2>最新评论</h2>
            <dl>
                <dt><img src="<%=path%>/resources/images/s8.jpg">
                <dt>
                <dd>DanceSmile
                    <time>49分钟前</time>
                </dd>
            ...
            <dl>
                <dt><img src="<%=path%>/resources/images/s7.jpg">
                <dt>
                <dd>yisa
                    <time>2小时前</time>
                </dd>
            ...
            <dl>
                <dt><img src="<%=path%>/resources/images/s6.jpg">
                <dt>
                <dd>小林博客
                    <time>8月7日</time>
                </dd>
        ...
        <section class="flickr">
            <h2>摄影作品</h2>
            <ul>
                <li><a href="/"><img src="<%=path%>/resources/images/01.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/02.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/03.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/04.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/05.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/06.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/07.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/08.jpg"></a></li>
                <li><a href="/"><img src="<%=path%>/resources/images/09.jpg"></a></li>
            </ul>
        </section>
    </div>
